...
class SyncStatus {
  ...
  factory SyncStatus.initial() => SyncStatus(networkState: NetworkState.offline);
...
class EnhancedSyncService {
  ...
  void _startNetworkMonitoring() {
    _networkCheckTimer?.cancel();
    _networkCheckTimer = Timer.periodic(const Duration(seconds: 30), (_) => _checkNetwork());
    // Check immediately
    _checkNetwork();
  }
  ...
  Future<void> syncAll() async {
    ...
    if (!kDemoAuthLogin && !AppConvexConfig.isAuthenticated) {
      return;
    }
