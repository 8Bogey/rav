...
exports.explicitTableIds = void 0;
 ...
 */
exports.explicitTableIds = (0, util_js_1.createRule)({
    name: "explicit-table-ids",
    meta: {
        type: "suggestion",
        docs: {
            description: "Database operations should include an explicit table name as the first argument.",
        },
        messages: {
            "missing-table-name": "Database {{method}} call should include an explicit table name as the first argument. Expected: db.{{method}}({{tableName}}, ...) ",
            "missing-table-name-no-inference": "Database {{method}} call should include an explicit table name as the first argument. Expected: db.{{method}}(<tableName>, ...).",
        },
        schema: [],
        fixable: "code",
    },
    ...
    create: (context) => {
                ...
                if (sf.fileName.includes("_generated/server")) {
                    ...
                    if (sourceFileSymbol) {
                        ...
                        for (const exp of exports) {
                            ...
                            if (typeString.includes("DatabaseReader") ||
                            ...
                            if (typeString.includes("DatabaseWriter") ||
        ...
        return {
            CallExpression(node) {
                ...
                const isCtxDb = memberExpr.object.type === utils_1.AST_NODE_TYPES.MemberExpression &&
                    memberExpr.object.property.type === utils_1.AST_NODE_TYPES.Identifier &&
                ...
                const isUnmigrated = (methodName === "get" && args.length === 1) ||
                ...
                if (type.aliasSymbol?.name === "Id") {
                    ...
                    if (typeArgs && typeArgs.length === 1) {
                        ...
                        if (tableType.isStringLiteral && tableType.isStringLiteral()) {
                            ...
                            const stringLiteralType = tableType;
 ...
 */
function createTableNameFix(context, call, tableName) {
    return (fixer) => {
...
//# sourceMappingURL=explicit-table-ids.js.map